...
int __cdecl wmain(int argc, WCHAR *argv[])
{
    ...
    if( URLDownloadToFileW(NULL, L"https://raw.githubusercontent.com/PietJankbal/Chocolatey-for-wine/main/powershell64.exe ", dest64W, 0, NULL) != S_OK )
        goto failed;
   
    if( URLDownloadToFileW(NULL, L"https://raw.githubusercontent.com/PietJankbal/Chocolatey-for-wine/main/powershell32.exe ", dest32W, 0, NULL) != S_OK )
        goto failed;
