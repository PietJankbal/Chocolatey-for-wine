...
if(Test-Path 'env:SCOOP_INSTALL'){
    ...
    Start-Process ${env:ProgramFiles}\\7-zip\\7z.exe  -ArgumentList "x","$env:TEMP\\Windows6.0-KB936330-X64-wave1.exe","-o$env:TEMP","amd64_microsoft-windows-robocopy_31bf3856ad364e35_6.0.6001.18000_none_2325cb04a4c1adef/robocopy.exe"
    Start-Process ${env:ProgramFiles}\\7-zip\\7z.exe  -ArgumentList "x","$env:TEMP\\Windows6.0-KB936330-X64-wave1.exe","-o$env:TEMP","x86_microsoft-windows-robocopy_31bf3856ad364e35_6.0.6001.18000_none_c7072f80ec643cb9/robocopy.exe"

    Start-Process ${env:ProgramFiles}\\7-zip\\7z.exe  -ArgumentList "x","$env:TEMP\\Windows6.0-KB936330-X64-wave1.exe","-o$env:TEMP","amd64_microsoft-windows-mfc42x_31bf3856ad364e35_6.0.6001.18000_none_4f3369c50dec2a50/mfc42u.dll"
    Start-Process ${env:ProgramFiles}\\7-zip\\7z.exe  -ArgumentList "x","$env:TEMP\\Windows6.0-KB936330-X64-wave1.exe","-o$env:TEMP","x86_microsoft-windows-mfc42x_31bf3856ad364e35_6.0.6001.18000_none_f314ce41558eb91a/mfc42u.dll"
