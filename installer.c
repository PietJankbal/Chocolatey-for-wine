...
struct paths {
    ...
    /* __attribute__((section(".text")))   __attribute__((aligned(8))) */ static const WCHAR url[5][165] = {L"http://download.windowsupdate.com/msdownload/update/software/crup/2010/06/windows6.1-kb958488-v6001-x64_a137e4f328f01146dfa75d7b5a576090dee948dc.msu",
